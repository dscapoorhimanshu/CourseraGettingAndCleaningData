...
Repository for Cousera: https://class.coursera.org/getdata-031
...
> 3) clone this repository : git clone https://github.com/dscapoorhimanshu/CourseraGettingAndCleaningData

> 4) change directory into the CourseraGettingAndCleaningData  directory
...
====================================
> Review the run_analysis.R script in the root of the cloned repository. refer comments in file.
